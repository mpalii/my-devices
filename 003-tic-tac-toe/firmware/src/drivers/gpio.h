 ...
 */
#define LED_SOURCE_1            _PB0
#define LED_SOURCE_2            _PB1
#define LED_SOURCE_3            _PB2
#define LED_DRAIN_1_X           _PB3
#define LED_DRAIN_1_O           _PB4
#define LED_DRAIN_2_X           _PB5
#define XTAL1                   _PB6
#define XTAL2                   _PB7
...
#define LED_DRAIN_2_O           _PD0
#define LED_DRAIN_3_X           _PD1
#define LED_DRAIN_3_O           _PD2
